...
typedef int (*pthread_create_t)(pthread_t *, const pthread_attr_t *, ThreadFunc,
                                void *);
...
extern "C" DLLEXPORT int pthread_create(pthread_t *thread,
...
extern "C" DLLEXPORT void pthread_exit(void *retval) {
...
extern "C" DLLEXPORT void *dlopen(const char *filename, int flags) {
...
void Hooks::shutdown() { Profiler::instance()->shutdown(_global_args); }
