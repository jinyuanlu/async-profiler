...
// Returns an error message for the given error code or NULL if there is no
// error
...
DLLEXPORT asprof_error_t asprof_execute(const char *command,
                                        asprof_writer_t output_callback);
typedef asprof_error_t (*asprof_execute_t)(const char *command,
                                           asprof_writer_t output_callback);
